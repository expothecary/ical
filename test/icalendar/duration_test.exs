defmodule ICalendar.DurationTest do
  use ExUnit.Case

  alias ICalendar.Duration

  alias ICalendar.Deserialize.Duration, as: Deserialize
  alias ICalendar.Serialize.Duration, as: Serialize
  ...
  test "ICalendar.Duration deserialization" do
  ...
  test "ICalendar.Duration serialization" do
