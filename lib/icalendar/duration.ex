defmodule ICalendar.Duration do
  @moduledoc """
  A struct representing an ICalendar duration, representing the numbers days, weeks, and/or a measure time over which something occurs or lasts.
